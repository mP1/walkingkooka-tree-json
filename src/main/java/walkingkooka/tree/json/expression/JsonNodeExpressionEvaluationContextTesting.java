...
public interface JsonNodeExpressionEvaluationContextTesting<C extends JsonNodeExpressionEvaluationContext> extends ExpressionEvaluationContextTesting<C> {
