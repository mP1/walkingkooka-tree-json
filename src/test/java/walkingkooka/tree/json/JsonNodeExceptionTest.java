...
public final class JsonNodeExceptionTest implements StandardThrowableTesting<JsonNodeException> {

    @Override
    public JsonNodeException createThrowable(final String message) {
        return new JsonNodeException(message);
    }
