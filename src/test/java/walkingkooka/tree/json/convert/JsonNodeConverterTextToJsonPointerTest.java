...
public final class JsonNodeConverterTextToJsonPointerTest extends JsonNodeConverterTextToTestCase<JsonNodeConverterTextToJsonPointer<FakeJsonNodeConverterContext>, FakeJsonNodeConverterContext> {
    ...
    public void testConvertStringToJsonPointer() {
        final String pointer = "/hello/world";/**/
    ...
    @Override
    public JsonNodeConverterTextToJsonPointer<FakeJsonNodeConverterContext> createConverter() {
    ...
    public void testToString() {
        this.toStringAndCheck(
            JsonNodeConverterTextToJsonPointer.instance(),
            "TEXT to JsonPointer"
        );
    }
    ...
    @Override
    public Class<JsonNodeConverterTextToJsonPointer<FakeJsonNodeConverterContext>> type() {
        return Cast.to(JsonNodeConverterTextToJsonPointer.class);
    }
}
