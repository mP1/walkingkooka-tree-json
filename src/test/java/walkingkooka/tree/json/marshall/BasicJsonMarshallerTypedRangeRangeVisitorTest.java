...
public final class BasicJsonMarshallerTypedRangeRangeVisitorTest extends BasicTestCase<BasicJsonMarshallerTypedRangeRangeVisitor<?>> {
    ...
    @Override
    public Class<BasicJsonMarshallerTypedRangeRangeVisitor<?>> type() {
        return Cast.to(BasicJsonMarshallerTypedRangeRangeVisitor.class);
    }

    @Override
    public String typeNamePrefix() {
        return BasicJsonMarshallerTypedRange.class.getSimpleName();
    }
