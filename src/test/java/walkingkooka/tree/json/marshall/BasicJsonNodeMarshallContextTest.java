...
public final class BasicJsonNodeMarshallContextTest extends BasicJsonNodeContextTestCase<BasicJsonNodeMarshallContext>
    ...
    private JsonNode keyValueEntry(final Integer key,
    ...
    public void testMarshallMapWithTypeBooleanTrue() {
        this.marshallMapWithTypeAndCheck3(
            JsonNode.booleanNode(true),
            true
        );
    }
    ...
    private JsonNodeMarshallContext contextWithProcessor() {
        return this.createContext()
            .setObjectPostProcessor(this::objectPostProcessor);
    }

    private JsonObject objectPostProcessor(final Object value,
                                           JsonObject object) {
        return object.set(
            POST,
            POST_VALUE
