...
public final class JsonNodeObjectBeginSymbolParserTokenTest extends JsonNodeSymbolParserTokenTestCase<JsonNodeObjectBeginSymbolParserToken> {
    ...
    @Override
    public Class<JsonNodeObjectBeginSymbolParserToken> type() {
