...
public final class JsonNodeSeparatorSymbolParserTokenTest extends JsonNodeSymbolParserTokenTestCase<JsonNodeSeparatorSymbolParserToken, String> {
    ...
    @Override
    JsonNodeSeparatorSymbolParserToken createToken(final String value, final String text) {
        return JsonNodeSeparatorSymbolParserToken.with(value, text);
    }

    @Override
    public JsonNodeSeparatorSymbolParserToken createDifferentToken() {
        return JsonNodeSeparatorSymbolParserToken.with(this.text(), "different");
    }

    @Override
    public Class<JsonNodeSeparatorSymbolParserToken> type() {
        return JsonNodeSeparatorSymbolParserToken.class;
    }
}
