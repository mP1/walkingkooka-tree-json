...
public abstract class ParentJsonNodeParserTokenTestCase<T extends ParentJsonNodeParserToken<T>> extends JsonNodeParserTokenTestCase<T> {

    ParentJsonNodeParserTokenTestCase() {
        super();
    }
